...
<head>
    <meta charset="utf-8" />
    <meta name="feelingport" content="width=device-width, initial-scale=1.0" />
...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        <div id="page-inner">
            <p style="font-weight: bold">Feeling: {{$feelingDB->name}}</p>
            <div class="showSongInAlbumFeeling" style="overflow: scroll; height: 250px">
                <table class="table table-striped table-bordered table-hover table-condensed">
                    ...
                    @if($albumFeeling != null)
                        @foreach($albumFeeling as $song)
                            <?php $songFeeling = DB::table("song")->where("id", $song->song_id)->first();?>
                            <tr>
                                <th>{{$songFeeling->id}}</th>
                                <th>{{$songFeeling->name}}</th>
                                <th>
                                    <a href="{{ URL::route("deleteSongInAlbumFeeling", ["song_id" => $songFeeling->id, "feeling_id" => $feelingDB->id])}}"><button class="btn-danger" onclick="">Delete</button></a>
                                </th>
                            </tr>
                        @endforeach
                    @endif
                ...
                <table class="table table-striped table-bordered table-hover table-condensed">
                    ...
                    @foreach($songDB as $song)
                        <tr>
                            ...
                            <th>{{$song->name}}</th>
                            <th>
                                <a href="{{ URL::route("addSongToAlbumFeeling", ["song_id" => $song->id, "feeling_id" => $feelingDB->id])}}"><button class="btn-primary" onclick="">Add</button></a>
                            </th>
                        </tr>
                    @endforeach
                </table>
