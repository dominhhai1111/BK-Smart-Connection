...
<head>
    ...
    <title>BK Smart Connection</title>
    <!-- Bootstrap Styles-->
...
<div id="wrapper">
    ...
    <div id="page-wrapper" >
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    @foreach($circumstances as $circumstance)
                                        <th>{{$circumstance->id}}</th>
                                        <th>{{$circumstance->topic}}</th>
                                        <th>{{$circumstance->feeling}}</th>
                                    @endforeach
                                    </tbody>
                                </table>
                            </div>
        ...
        <footer><p>All right reserved. Template by: Đỗ Minh Hải</p></footer>
    </div>
    <!-- /. PAGE INNER  -->
</div>
<!-- /. PAGE WRAPPER  -->
